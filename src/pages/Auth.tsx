...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center pt-12 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 shadow-xl rounded-2xl overflow-hidden">
          <motion.div
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5 }}
            className="bg-primary/10 p-12 hidden md:flex md:flex-col"
          >
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={form.password}
                    onChange={handleChange}
                    className="glass-input w-full px-4 py-3 pr-10"
